...
#Jenny Smith 
#Purpose: recursively find working directories in Rmd analysis scripts, 
# and create a new directory name matching the data analysis directory (working dir)
...
# SCRIPTS="/home/jlsmith3/scripts/RNAseq_Analysis/Analysis"
# SCRIPTS="/home/jlsmith3/scripts/RNAseq_Analysis/Waterfallplots_Expression_Distribution"
# SCRIPTS="/home/jlsmith3/scripts/RNAseq_Analysis/Concatenation"
# SCRIPTS="/home/jlsmith3/scripts/RNAseq_Analysis/BatchEffect"
# SCRIPTS="/home/jlsmith3/scripts/survival_analysis"
# SCRIPTS="/home/jlsmith3/scripts/nanostring_analysis"
SCRIPTS="/home/jlsmith3/scripts/miRNAseq_analysis"
SCRIPT_DIR=$(basename $SCRIPTS)

#Use find to recursively grep the working directory (output directory) for each the analysis R scripts 
...
#remove those filepaths that were called `setwd(path)` or `setwd(out)` as those files were called in code chuncks of Rmd files for temp work.
#and remove those with #setwd() which were commented out 
...
#Loop through row of the arrays and create a directory from $clean_dirs, and make a copy of the R script file there
for i in ${!DIRS[@]};
do
    file="${RFILES[$i]}";
    dir="${DIRS[$i]}";
